...
public abstract class TeamCompetitionJava extends Competition {
	...
	protected TeamCompetitionJava(final CompetitionType type) {
		this(type, false);
	}
	
	protected TeamCompetitionJava(final CompetitionType type, boolean subsidiary) {
